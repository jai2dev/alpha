         ...
         <div className="lawda">
            ...
            <div className="dada">
               ...
               <div className="columns download">
                  <p>
                     <a href="https://drive.google.com/file/d/19sX-mkwVxW-lc-wcjK3wwnArI3-6nODv/view?usp=sharing" className="button"><FontAwesomeIcon icon={faDownload} /> View Resume</a>
                  </p>
               </div>
            </div>
         </div>
